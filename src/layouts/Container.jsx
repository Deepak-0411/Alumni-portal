  ...
  return (
    <div className="my-6">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-3xl text-gray-800 border-l-4 border-violet-500 pl-3">
          {heading}
        </h1>
        <button className="mx-20  cursor-pointer bg-purple-200/60 text-purple-600 font-semibold border-purple-200  px-4 py-2 rounded-full hover:bg-gray-200">
          + Create
        </button>
      </div>

      <div className="bg-gray-100 p-6 mx-20 rounded-xl h-120 ">
