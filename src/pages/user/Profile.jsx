    ...
    <div className={styles.container}>
      ...
      <div className={styles.dataBox}>
        <div className={styles.headingBox}>
          <h2 className={styles.heading}>Profile Data</h2>
        </div>
        <div className={styles.pbox}>
          <img className={styles.dp} src={formData.dp || DP} alt="Profile Pic" />
          <div className={styles.subBox}>
            <p className={styles.title}>Name</p>
            <p className={styles.data}>{formData.Name}</p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.dataBox}>
        ...
        <div className={styles.box}>
          <div className={styles.subBox}>
            ...
            <p className={styles.data}>{formData.dob}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>Father's Name</p>
            <p className={styles.data}>{formData.Fathername}</p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.dataBox}>
        ...
        <div className={styles.box}>
          <div className={styles.subBox}>
            ...
            <p className={styles.data}>{formData.phoneNo}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>E-mail</p>
            <p className={styles.data}>{formData.email}</p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.dataBox}>
        ...
        <div className={styles.box}>
          <div className={styles.subBox}>
            <p className={styles.title}>Enrollment Number</p>
            <p className={styles.data}>{formData.enrollmentNo}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>Roll Number</p>
            <p className={styles.data}>{formData.rollNo}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>Year Of Passing"</p>
            <p className={styles.data}>{formData.yearOfPassing}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>School</p>
            <p className={styles.data}>{formData.school}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>Programme</p>
            <p className={styles.data}>{formData.programme}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>Country</p>
            <p className={styles.data}>{formData.country || "-"}</p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.dataBox}>
        ...
        <div className={styles.box}>
          <div className={styles.subBox}>
            ...
            <p className={styles.data}>{formData.x || "-"}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>Insta</p>
            <p className={styles.data}>{formData.insta || "-"}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>LinkedIn</p>
            <p className={styles.data}>{formData.linkedIn || "-"}</p>
          </div>
          <div className={styles.subBox}>
            <p className={styles.title}>Github</p>
            <p className={styles.data}>{formData.gitHub || "-"}</p>
          </div>
        </div>
      </div>
    </div>
