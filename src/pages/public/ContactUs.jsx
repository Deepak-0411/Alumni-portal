import styles from "../../styles/modules/public/ContactUs.module.css";
    ...
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.adderess}>
          ...
          <p className={styles.text}>Phone No : 01202344209</p>
          <p className={styles.text}>Email : gbuaa@gbu.ac.in</p>
        </div>
      </div>
    </div>
  );
